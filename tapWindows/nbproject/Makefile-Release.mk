...
dist/Release/Cygwin-Windows/libtrunk.dll: ${OBJECTFILES}
	...
	${LINK.c} -mno-clwb -shared -o dist/Release/Cygwin-Windows/libtrunk.dll -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/com_myonvpn_tuntap_TunTapWindows.o: com_myonvpn_tuntap_TunTapWindows.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -O2 -fPIC  -o ${OBJECTDIR}/com_myonvpn_tuntap_TunTapWindows.o com_myonvpn_tuntap_TunTapWindows.c
